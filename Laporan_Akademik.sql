...
(
   ...
   JURUSAN_MK INTEGER CONSTRAINT JURUSAN_MASTER_MATAKULIAH NOT NULL REFERENCES MASTER_JURUSAN(KODE_MJ),
...
(
   KODE_JADWAL_MK NUMBER(10) CONSTRAINT KODE_JADWAL_MATAKULIAH NOT NULL PRIMARY KEY,
   KODE_MK VARCHAR(10) CONSTRAINT KODE_MATAKULIAH NOT NULL REFERENCES MASTER_MATAKULIAH(KODE_MK),
   JURUSAN_MK INTEGER CONSTRAINT JURUSAN_JADWAL_MATAKULIAH NOT NULL  REFERENCES MASTER_JURUSAN(KODE_MJ),
...
(
   ...
   JURUSAN_MHS INTEGER CONSTRAINT JURUSAN_MAHASISWA NOT NULL  REFERENCES MASTER_JURUSAN(KODE_MJ),
...
(
   KODE_PENGAMBILAN_MK NUMBER(10) CONSTRAINT KODE_PENGAMBILAN_MATAKULIAH NOT NULL PRIMARY KEY,
   NRP_MHS INTEGER CONSTRAINT PM_NRP_MHS NOT NULL REFERENCES MAHASISWA(NRP_MHS),
   KODE_MK VARCHAR(10) CONSTRAINT PM_KODE_MK NOT NULL REFERENCES MASTER_MATAKULIAH(KODE_MK),
...
/* TIRGGER AUTO INCREMENT PENGAMBILAN_MATAKULIAH */
DROP SEQUENCE KODE_PENGAMBILAN_SEQ;
CREATE SEQUENCE KODE_PENGAMBILAN_SEQ START WITH 1;
CREATE OR REPLACE TRIGGER AI_PENGAMBILAN 
BEFORE INSERT ON PENGAMBILAN_MATAKULIAH 
FOR EACH ROW

BEGIN
  SELECT KODE_PENGAMBILAN_SEQ.NEXTVAL
  INTO   :new.KODE_PENGAMBILAN_MK
  FROM   dual;
END;
/

/* TIRGGER AUTO INCREMENT JADWAL_MATAKULIAH */
DROP SEQUENCE KODE_JADWAL_MATAKULIAH_SEQ;
CREATE SEQUENCE KODE_JADWAL_MATAKULIAH_SEQ START WITH 1;
CREATE OR REPLACE TRIGGER AI_JADWAL_MATAKULIAH 
BEFORE INSERT ON JADWAL_MATAKULIAH 
FOR EACH ROW

BEGIN
  SELECT KODE_JADWAL_MATAKULIAH_SEQ.NEXTVAL
  INTO   :new.KODE_JADWAL_MK
  FROM   dual;
END;
/
